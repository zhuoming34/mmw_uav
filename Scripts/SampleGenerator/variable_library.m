...
N_placement_car = 1; % # of placement we create with every selected car/group of cars

% angle of rotation for every model
rotate_ang_coarse = [0:15:360];
rotate_ang_fine = [-5:5];
rotate_ang = [];
...
translate_lim = [-4000, 4000; 3500, 10000]; % [-4000, 4000; 3500, 12000]; limits of the translation along the x and y axis
translate_x_res = 100; %500; % resolution of translation along the x axis unit: mm
translate_y_res = 100; %500; % resolution of translation along the y axis unit: mm
